...
def test_parallel_readability_report_is_diagnostic_and_keeps_provenance():
    ...
    assert report["candidate_count"] == 5501
    ...
    assert by_source["runs/luna-semantic-lexical-path-solver-20260917.json"]["rows"] == 6
    ...
    assert by_source["runs/luna-punctuation-center-bridge-20260917.json"]["rows"] == 116
    assert by_source["runs/luna-affix-crossword-prose-20260917.json"]["rows"] == 38
