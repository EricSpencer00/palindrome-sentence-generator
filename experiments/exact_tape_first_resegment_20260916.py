...
TARGET='quietkeeperscarrywarmbreadtotheriver' # seed half; reflected below
...
def main():
 half=tape(TARGET); target=half+half[::-1]; left='Quiet keepers carry warm bread to the river'; right='revirehtotdaerbmrawyrracsrepeek teiuq'; rendered=left+'; '+right; lt,rt=tape(left),tape(right); p=ptr(lt,rt)
