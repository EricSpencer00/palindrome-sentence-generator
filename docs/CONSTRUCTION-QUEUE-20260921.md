...
| Corpus role-bank online CSP + seam recombination + valency gate | `experiments/corpus_role_online_csp_20260921.py`; `runs/corpus-role-online-csp-20260921.json`; commits `dcc29a34`, `530b0c68`, `0341845b` | 40 recombined three-clause shapes; 22,172,199 bounded search nodes; maximum 43 letters; subject/verb/complement valency is enforced before lexical branching; 0 exact. | Expand the role transition inventory with held-out valency-compatible seams, not raw Cartesian breadth. |
