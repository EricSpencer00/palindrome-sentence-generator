...
def build() -> None:
    ...
    fresh = [
        ...
        [p("Lexical reverse automaton + Luna frontier", small), p("Brown trie: 2,058 renderings, 2,401 states, 74 letters, 0 exact-clean. Follow-ups: object-gap/ditransitive/benefactive/boundary3/instrumental/temporal-subject-relative/right-benefactive controls to 87/142/119/64/70/177/108 letters; all 0 exact-clean. A 286,561-letter dynamic inventory is exact but catalogue-like word salad.", small), p("Expand typed role classes only at new endpoint or grammar frontiers; keep the reader gate closed.", small)],
    ]
