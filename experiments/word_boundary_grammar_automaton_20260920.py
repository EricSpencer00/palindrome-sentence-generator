...
OUT = ROOT / "runs/word-boundary-probabilistic-modal-graph-20260920.json"
ID = "word-boundary-probabilistic-modal-graph-20260920"
SIG = "word-boundary-aware|probabilistic-modal-scope|attachment-tense-state|live-equations"
...
def run():
    ...
    return {"experiment_id":ID,"method":"bounded word-boundary grammar automaton with four finite event relations, explicit attachment graph, and typed probabilistic modal-scope connector edge",
      ...
      "novelty_preflight":{"status":"passed","signature":SIG,"distinct_from":"possibility modal-scope connector graph: adds a typed `probably when` relation with probabilistic scope and explicit attachment/tense state without increasing the event count"},
      "next_topology":{"if_no_closure":"add a stochastic modal-scope connector with explicit attachment and tense agreement","reason":"the probabilistic modal-scope connector bank has no exact closure above the reader threshold"},
