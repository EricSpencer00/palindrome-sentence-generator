...
def test_parallel_readability_report_is_diagnostic_and_keeps_provenance():
    ...
    assert report["candidate_count"] == 5355
    ...
    assert len(report["route_summary"]) == 332
    ...
    assert by_source["runs/char-lm-decoding-20260916.json"]["rows"] == 1
    assert by_source["runs/cfg-earley-character-intersection-20260916.json"]["rows"] == 1
    assert by_source["runs/human-scene-lattice-live-equations-20260916.json"]["rows"] == 1
    assert by_source["runs/luna-exact-near-survivor-repair-20260917.json"]["rows"] == 3
    assert by_source["runs/luna-memoized-brown-intersection-20260917.json"]["rows"] == 4
    assert by_source["runs/luna-phrase-chunk-semantic-decoder-20260917.json"]["rows"] == 15
    assert by_source["runs/scene-lattice-live-character-equations-20260917.json"]["rows"] == 3
    assert by_source["runs/luna-palindromic-scene-realizer-20260917.json"]["rows"] == 3
    assert by_source["runs/luna-boundary-semantic-repair-20260917.json"]["rows"] == 3
    assert by_source["runs/luna-cfg-frame-repair-20260917.json"]["rows"] == 1
    assert by_source["runs/luna-readable-palindrome-manual-search-20260917.json"]["rows"] == 1
    ...
    assert by_source["runs/luna-lexicalized-reverse-trie-grammar-20260917.json"]["rows"] == 3
    assert by_source["runs/luna-inflection-clitic-seam-scene-solver-20260917.json"]["rows"] == 24
    assert by_source["runs/luna-recursive-balanced-grammar-20260917.json"]["rows"] == 5
    assert by_source["runs/luna-punctuation-center-bridge-20260917.json"]["rows"] == 12
    assert by_source["runs/luna-affix-crossword-prose-20260917.json"]["rows"] == 5
    assert by_source["runs/dependency-semantic-seam-csp-v2-20260917.json"]["rows"] == 3
    ...
    assert by_source["runs/agreement-morphology-transducer-20260916-luna.json"]["rows"] == 1
    assert by_source["runs/semantic-valency-attachment-solver-20260916-luna.json"]["rows"] == 1
    assert by_source["runs/scalable-compositional-grammar-20260916-luna.json"]["rows"] == 10
    assert by_source["runs/exact-tape-grammatical-resegmentation-20260916-luna.json"]["rows"] == 1
    assert by_source["runs/semantic-slot-substitution-repair-20260916-luna.json"]["rows"] == 1
    assert by_source["runs/inflection-clitic-distinct-repair-20260916-luna.json"]["rows"] == 1
    assert by_source["runs/free-center-semantic-state-machine-20260916/run.json"]["rows"] == 1
    assert by_source["runs/phrase-level-reverse-parser-20260916.json"]["rows"] == 9
    assert by_source["runs/clause-equation-sat-20260916.json"]["rows"] == 1
    assert by_source["runs/dialogue-speech-act-grammar-20260916-qaser.json"]["rows"] == 1
    assert by_source["runs/typed-morpheme-compound-20260916.json"]["rows"] == 1
    assert by_source["runs/typed-equation-grammar-20260916.json"]["rows"] == 1
    assert by_source["runs/astar-typed-word-boundary-20260916.json"]["rows"] == 1
    assert by_source["runs/human-two-sentence-slot-search-20260916.json"]["rows"] == 7
    assert by_source["runs/free-center-semantic-bridge-20260916-luna.json"]["rows"] == 1
    assert by_source["runs/grammar-pair-composition-20260916.json#base"]["rows"] == 4
    assert by_source["runs/grammar-pair-composition-20260916.json#repair"]["rows"] == 4
    assert by_source["runs/paired-lexical-grammar-20260916.json"]["rows"] == 6
    assert by_source["runs/grapheme-chunk-finite-state-constructor-20260916.json"]["rows"] == 12
    assert by_source["runs/hand-authored-function-edit-extension-20260916.json"]["rows"] == 5
    ...
    assert by_source["runs/lexical-word-equation-grammar-intersection-20260916.json"]["rows"] == 4
    assert by_source["runs/centerout-typed-semantic-debt-20260916.json"]["rows"] == 12
