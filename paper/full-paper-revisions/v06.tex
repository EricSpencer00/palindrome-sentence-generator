...
\title{Mirror Cost and Lexical Coverage under Exact Reversal}
...
\begin{document}
% Full-paper snapshot 6; critique and successor changes are in FULL-PAPER-REVISION-LEDGER.md.
\maketitle

\begin{abstract}
We report both mirror cost and the fraction of letters placed in dictionary words of at least three characters. Forward coverage is 88--92\% compared with 48--55\% in reverse, alongside the likelihood penalty. The diagnostics describe lexical availability, not prose quality.
\end{abstract}
...
Coverage is now separated from likelihood, but the decoder's POS filter still risks being mistaken for a grammar model.

\section*{Limitations}

Dictionary coverage can be high for nonsense. No metric here establishes grammaticality, coherence, or meaning.
