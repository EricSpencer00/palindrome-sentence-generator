...
spec=importlib.util.spec_from_file_location('lane',ROOT/'experiments/morphology_crossword_transducer_20260916.py');lane=importlib.util.module_from_spec(spec);spec.loader.exec_module(lane)
def test_morphology_transducer():
