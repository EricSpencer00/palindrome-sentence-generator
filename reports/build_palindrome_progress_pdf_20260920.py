...
def build() -> None:
    ...
    fresh = [
        ...
        [p("Lexical reverse automaton", small), p("Brown frequency inventory only; 2,058 typed-clause renderings; 2,401 online states; longest 74 letters; 0 exact-clean above 38.", small), p("Expand held-out typed role classes while retaining online trie intersection.", small)],
    ]
