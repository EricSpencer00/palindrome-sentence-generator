...
SYNCHRONOUS_GRAMMAR_PRODUCT_RUN = {
    ...
    "reader_status": "not_run; no exact candidate reached the reader gate",
    "next_construction_discriminator": "add only endpoint lexical classes that create a new live outer character orbit, then rerun the same full-trie product",
}
