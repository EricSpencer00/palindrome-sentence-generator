...
CFG_CENTER_OUT_RUN = {
    ...
    "status": "completed_no_exact_closure",
    "derivations_attempted": 72,
    "center_out_states": 0,
    "early_pruned_derivations": 72,
    "exact_candidates": 0,
    "reader_worthy_candidates": 0,
...
OPTIMIZATION_SPEC = {
    ...
    "current_search": "cfg-center-out-intersection-20260919",
    "search_history": [
