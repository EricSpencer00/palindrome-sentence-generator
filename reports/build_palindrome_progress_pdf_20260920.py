...
def build() -> None:
    ...
    fresh = [
        ...
        [p("Lexical reverse automaton + Luna frontier", small), p("Brown trie: 2,058 renderings, 2,401 states, 74 letters, 0 exact-clean. Follow-ups: object-gap/ditransitive/benefactive/boundary3/instrumental/temporal-subject-relative/right-benefactive/right-instrumental/matrix-perfect controls to 87/142/119/64/70/177/108/110/186 letters; all 0 exact-clean. Endpoint-indexed reverse grammar reached 4 states/2 frontiers with 0 complete pairs. A 286,561-letter dynamic inventory is exact but catalogue-like word salad.", small), p("Expand typed role classes only at new endpoint or grammar frontiers; keep the reader gate closed.", small)],
        [p("Typed agreement false-positive replay", small), p("Five asymmetric templates; 1,981 live nodes; determiner/noun and subject/verb number carried before closure; 0 agreement-valid exact rows. The two malformed 39-letter broad-POS controls stay diagnostic.", small), p("Add transitive/intransitive valency to the live residual key.", small)],
    ]
    ...
    story += [t3, Spacer(1, 10), Paragraph("Recent committed method work", h1), Paragraph("0fc9f8dc packed sentence-plan boundary DP; f6a4e140 lexical reverse-trie grammar; 70b76dc9 first Luna frontier; b2f26d50 relative attachment; 57b56059 ditransitive/relative seams; 89696892 two-character boundary; b11af302 object-gap relative; 1c1c8f15 boundary3; 1aab9d70 benefactive/subject-relative; f440a03d temporal subject-relative; 4bad44d4 boundary-diverse instrumental-relative; de3ada73 right benefactive-gap; 092bde72 right instrumental source-gap; dd91cfa5 matrix-perfect temporal; typed-agreement replay (remote) false-positive filter.", body), Paragraph("Bottom line", h1), Paragraph("The public API is inspiring as a search/indexing and inspection reference. It does not change the success criterion: the next claimed win must be an actual long English palindrome that survives independent exact validation, novelty/shortcut checks, and blinded readers.", callout)]
