...
def test_parallel_readability_report_is_diagnostic_and_keeps_provenance():
    ...
    assert report["candidate_count"] == 5442
    ...
    assert by_source["runs/luna-punctuation-center-bridge-20260917.json"]["rows"] == 72
    assert by_source["runs/luna-affix-crossword-prose-20260917.json"]["rows"] == 23
