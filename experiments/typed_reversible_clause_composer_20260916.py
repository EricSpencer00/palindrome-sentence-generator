...
TEXTS=['The harbor keeper checks the lanterns before dawn, and the night watch records each change in the log for careful readers near the quay.','The patient gardener waters the eastern beds after rain, and the young helper carries fresh tools to the shed for the morning crew.']
def audit(s):
