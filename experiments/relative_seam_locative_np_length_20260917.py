"""Bounded locative noun-phrase length repair."""
import hashlib,json,re
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1]; EXPERIMENT='relative-seam-locative-np-length-20260917'
...
CHOICES=[('can still','a map','by','the inlet','short_np'),('cannot yet','maps','near','the old docks','expanded_np')]
