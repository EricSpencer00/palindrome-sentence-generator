"""Bounded relative-attachment/locative-noun repair."""
import hashlib,json,re
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1]; EXPERIMENT='relative-seam-attachment-locative-noun-20260918'
...
CHOICES=[('who marks the harbor map','she','records','a map','by','the inlet','subject_inlet'),('that the guide carried the cedar key','the keepers','carry','maps','near','our shores','object_shores')]
