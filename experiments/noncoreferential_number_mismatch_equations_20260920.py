...
def fok(s,v,t,p,r,cx,state):return vok(s,v) and v.valency=="dative" and t.valency=="patient" and t.animacy=="inanimate" and p.relation==state and p.text==("for" if state=="benefit" else "to") and r.valency=="animate-recipient" and r.animacy=="animate" and cx.relation==state
def controls():
 ts=["Mara gives the letter for the child although the sailors send books for the children.","The guards bring the seal for a friend although Noah offers a book for the poet.","The poet shows a book for the child while the queens give letters to the children.","The poets send the letters to the children while a captain brings a book to a friend.","The queen gives a book for the poet although the guards send the seals for the children.","The sailors offer letters to a friend while Mara shows a book to the child.","A captain sends the seal for the poet although the poets bring books for the children.","The guards give a letter to the child while Noah offers books to a friend.","Mara sends the letters for a friend although the queens show a book for the poet.","The sailors bring a seal to the children while the poet gives books to the child.","The poets offer the letter for the child although a captain sends books for the children.","Noah shows the seal to a friend while the guards give letters to the poet.","The queen brings a book for the child although the sailors send seals for a friend.","The guards send letters to the children while Mara offers a book to the poet.","The poet gives the seal for a friend although the captains bring books for the children.","The sailors show a letter to the child while Noah sends books to the poet.","Mara offers a book for the poet although the queens give letters for the children.","The guards bring seals to a friend while a captain sends the letter to the child.","The poets send books for the children although the queen shows a seal for the poet.","Noah gives the letter to a friend while the guards offer books to the children."]
