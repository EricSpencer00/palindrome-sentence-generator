...
| `semantic-relation-alignment-20260916` | directed event-edge relations choose independent role lexicalizations while a deterministic boundary-synchronous ledger checks ordinary-order yields | semantic relation-edge alignment | 36,662 states; deepest match 6 characters; 0 exact/admitted/reader rows |
