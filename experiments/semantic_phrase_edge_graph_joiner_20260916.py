...
TEXTS=['The lighthouse keeper records the tide marks beside the storm-dark pier while the young deckhand mends a torn sail for the returning crew.','The patient botanist labels the winter seedlings in the glasshouse at dawn while the careful apprentice sorts the field notes for tomorrow’s lesson.','The lighthouse keeper records the tide marks beside the storm-dark pier while the young deckhand repairs a torn sail for the returning crew.']
def audit(s):
