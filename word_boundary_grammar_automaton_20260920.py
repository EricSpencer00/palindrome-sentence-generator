...
OUT = ROOT / "runs/word-boundary-temporal-until-graph-20260920.json"
ID = "word-boundary-temporal-until-graph-20260920"
SIG = "word-boundary-aware|temporal-until-relation|connector-edge|live-equations"
...
RELATION_EDGES = (("", "temporal"), (" because the record matters", "causal"), (" so the garden opens", "resultative"), (" although the path narrows", "concessive"), (" if the seal remains", "conditional"), (" until the lantern dims", "temporal-until"))
