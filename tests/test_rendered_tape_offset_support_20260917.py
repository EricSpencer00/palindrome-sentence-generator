...
RUN=Path(__file__).parents[1]/'runs/rendered-tape-offset-support-20260917.json'
def test_tape_offsets_and_audits():
 d=json.loads(RUN.read_text());assert d['candidate_count']==2
 for r in d['candidates']:
  assert r['rendered_slot_offsets'] and r['true_opposing_supports']
