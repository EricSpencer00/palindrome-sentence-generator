"""Matched branch: grammatical le-initial continuation after the proper locative."""
from pathlib import Path
import json,hashlib,re,itertools
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'runs/scene-lattice-survey-leeward-twelfth-20260917.json'
