...
| Corpus role-bank online CSP + seam/valency/relative grammar | `experiments/corpus_role_online_csp_20260921.py`; `runs/corpus-role-online-csp-20260921.json`; commits `dcc29a34`, `530b0c68`, `0341845b`, `043c4506`, `ac0a7542` | 43 controls, including held-out who/that/where templates; 28,871,780 online-CSP nodes; maximum shape over 38 letters; 0 exact. | Vary fixed-length role geometry and add relative antecedent domains, rather than widening the same lexical sets. |
