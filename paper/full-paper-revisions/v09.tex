...
\title{The Mirror Cost of English: A Measurement, Not a Demonstration}
...
\begin{document}
% Full-paper snapshot 9; critique and successor changes are in FULL-PAPER-REVISION-LEDGER.md.
\maketitle

\begin{abstract}
The controlled reverse-reading penalty is the paper's central contribution. The website is a system demonstration and the audited 90,937-letter Norvig-derived artifact is a stress test of exactness; neither is a semantic benchmark or a novelty claim.
\end{abstract}
...
The paper is centered correctly, but the abstract and limitations must consolidate its narrow scope.

\section*{Limitations}

The study lacks frozen sampled spans and model revisions, another corpus, another model family, and any blinded human-quality evaluation.
