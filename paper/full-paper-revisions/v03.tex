...
\title{Measuring Reversed English through Re-segmentation}
...
\begin{document}
% Full-paper snapshot 3; critique and successor changes are in FULL-PAPER-REVISION-LEDGER.md.
\maketitle

\begin{abstract}
We reverse normalized WikiText-2 letters, recover word boundaries, and compare the recovered reading with the source through a causal language model. The reverse reading is substantially less likely, motivating exact decoding as a constrained-generation application.
\end{abstract}
...
This draft introduces evidence, but it still risks mixing the cost of reversal with the shift from author-supplied spaces to automatically recovered boundaries.

\section*{Limitations}

The comparison is not yet symmetric. It is neither a theorem about English nor a human evaluation.
