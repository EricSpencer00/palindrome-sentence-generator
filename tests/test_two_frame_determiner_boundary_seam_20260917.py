...
ROOT=Path(__file__).parents[1];spec=importlib.util.spec_from_file_location("d",ROOT/"experiments/two_frame_determiner_boundary_seam_20260917.py");mod=importlib.util.module_from_spec(spec);spec.loader.exec_module(mod)
def test_determiner_boundary_uses_same_frames_and_audits():
