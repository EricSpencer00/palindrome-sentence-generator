...
| Corpus role-bank online CSP + seam recombination | `experiments/corpus_role_online_csp_20260921.py`; `runs/corpus-role-online-csp-20260921.json`; commits `dcc29a34`, `530b0c68` | 40 recombined three-clause shapes; 22,172,199 bounded search nodes; maximum 43 letters; 0 exact. Source clause order is crossed only through typed role domains, with source IDs retained. | Add bounded valency-compatible seam transitions rather than another Cartesian widening. |
