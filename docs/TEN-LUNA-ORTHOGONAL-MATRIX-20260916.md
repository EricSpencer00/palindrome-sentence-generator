...
authoritative aggregate is now **5,297 rows across 323 routes** with **83
exact and 0 mechanically admitted**, and the registry is **423 retained, 34
excluded, 401 retained run artifacts**.
