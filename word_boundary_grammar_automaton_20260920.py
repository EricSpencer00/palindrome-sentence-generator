...
OUT = ROOT / "runs/word-boundary-resultative-causal-graph-20260920.json"
ID = "word-boundary-resultative-causal-graph-20260920"
SIG = "word-boundary-aware|resultative-causal-relation|connector-edge|live-equations"
...
RELATION_EDGES = (("", "temporal"), (" because the record matters", "causal"), (" so the garden opens", "resultative"))
...
def run():
    ...
    return {"experiment_id":ID,"method":"bounded word-boundary grammar automaton with four finite event relations, explicit theme-headed attachment graph, and tense state",
      ...
      "novelty_preflight":{"status":"passed","signature":SIG,"distinct_from":"third-event attachment graph: object NP now carries an independent fourth finite event, distinct attachment index, and 3sg agreement state"},
      "next_topology":{"if_no_closure":"add a resultative or causal event relation with an explicit attachment graph and tense state","reason":"current four-event attachment-graph frame bank has no exact closure above the reader threshold"},
