...
authoritative aggregate is now **5,265 rows across 320 routes** with **83
exact and 0 mechanically admitted**, and the registry is **420 retained, 34
excluded, 398 retained run artifacts**.
