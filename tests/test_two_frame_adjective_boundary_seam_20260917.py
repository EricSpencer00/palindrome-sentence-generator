...
ROOT=Path(__file__).parents[1];spec=importlib.util.spec_from_file_location("a",ROOT/"experiments/two_frame_adjective_boundary_seam_20260917.py");mod=importlib.util.module_from_spec(spec);spec.loader.exec_module(mod)
def test_adjective_boundary_uses_ordinary_grammar_and_audits():
