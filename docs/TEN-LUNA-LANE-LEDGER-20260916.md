...
gate. The aggregate is now **5,265 rows across 320 routes, 83 exact rejected
tapes, and 0 mechanically admitted outputs**; the registry is **420 retained,
34 excluded, and 398 retained run artifacts**.
