...
| Corpus role-bank online CSP + seam recombination + valency profiles | `experiments/corpus_role_online_csp_20260921.py`; `runs/corpus-role-online-csp-20260921.json`; commits `dcc29a34`, `530b0c68`, `0341845b`, `043c4506` | 40 recombined three-clause shapes; 22,172,199 bounded search nodes; maximum 43 letters; transitive, ditransitive, prepositional, and relative profiles are audited before lexical branching; 0 exact. | Add a held-out relative-marker grammar bank; the current corpus has no relative-marker domain. |
