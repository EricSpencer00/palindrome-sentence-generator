...
authoritative aggregate is now **5,260 rows across 317 routes** with **83
exact and 0 mechanically admitted**, and the registry is **417 retained, 34
excluded, 395 retained run artifacts**.
