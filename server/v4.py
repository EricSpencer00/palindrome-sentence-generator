...
BEST_KNOWN_PROVENANCE = {
    ...
    "search_summary": {
        ...
        "latest_fresh_semordnilap_author": "Fresh prose-first semordnilap authoring: 32 complete question/scene frames to 30 letters, zero exact candidates above 38 or 50, with shortcut rejection and independent audits",
...
LUNA_PARALLEL_RUNS = [
    ...
    },
    {
        ...
        "frames": 2,
        "rendered": 32,
        "max_complete_frame_letters": 30,
        "exact_candidates_over_38": 0,
        "exact_candidates_over_50": 0,
        "reader_eligible": False,
        "example_near_miss": "Did the pilot read a civic by the quay?",
        "first_live_diagnostic": "outer d versus y mismatch in the complete question frame",
