...
SEMORDNILAP_POETIC_RUN = {
    ...
    "independent_validation": ["literal two-pointer", "forward/reverse SHA-256"],
    "reader_status": "one exact 56-letter candidate queued in the randomized blinded package; no human ratings yet",
    "next_construction_discriminator": "collect blinded human ratings, then add non-self pronoun/article frames only if this candidate loses to its shuffled control",
}
...
OPTIMIZATION_SPEC = {
    ...
    "current_search": "semordnilap-poetic-clause-20261001",
    "search_history": [
