"""Clause-valency alternation over independent full-clause factors.
...
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'runs/clause-valency-alternation-csp-20260920.json'
