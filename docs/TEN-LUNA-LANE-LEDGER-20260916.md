...
gate. The aggregate is now **5,260 rows across 317 routes, 83 exact rejected
tapes, and 0 mechanically admitted outputs**; the registry is **417 retained,
34 excluded, and 395 retained run artifacts**.
