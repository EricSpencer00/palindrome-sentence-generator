...
| Corpus role-bank online CSP + varied relative geometry | `experiments/corpus_role_online_csp_20260921.py`; `runs/corpus-role-online-csp-20260921.json`; commits `dcc29a34`, `530b0c68`, `0341845b`, `043c4506`, `ac0a7542`, `38ddd174` | 46 controls and six held-out relative-clause geometries; 67,395,870 live-CSP nodes; typed antecedent/marker/verb attachment retained; 0 exact. | Solve seam-specific word lengths online instead of widening lexical domains or replaying fixed geometry. |
