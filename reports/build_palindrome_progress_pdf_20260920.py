...
def build() -> None:
    ...
    fresh = [
        ...
        [p("Lexical reverse automaton + Luna frontier", small), p("Brown trie: 2,058 renderings, 2,401 states, 74 letters, 0 exact-clean. Follow-ups: object-gap/ditransitive/benefactive/boundary3 controls to 87/142/119/64 letters; all 0 exact-clean. A 286,199-letter dynamic inventory is exact but catalogue-like word salad.", small), p("Expand held-out role classes, temporal subject-relative edges, and new relative-temporal seam prefixes.", small)],
    ]
