"""Diversify the exact 666 center with a bounded same-window clause edit.

The edit keeps normalized window [297,369) fixed in size while replacing the
six-sees center with the reviewer-proposed finite-clause equation.
"""
...
PARENT = ROOT / "runs" / "incumbent-666-central-cluster-repair-20260922.json"
OUT = ROOT / "runs" / "incumbent-666-central-diversification-20260922.json"
PARENT_ID = "central-cluster-repair-nadia-sees-666"
PARENT_SHA256 = "3e8792786eb9a5f406251e2071650d7b0b53e1979cb1786df4d510ab9ff00d40"
CHILD_SHA256 = "6d96e68c2f9cffec70f2c688a89ed5ad2dcdf0a80097f1d711c28ec4fdad298a"
WINDOW_START = 297
WINDOW_SEAM = 333
WINDOW_END = 369
OLD_WINDOW = (
    "Nadia sees Mara. Nora sees Nadia. Ari sees God. "
    "Dog sees Ira. Aidan sees Aron. Aram sees Aidan"
)
NEW_LEFT = "Nadia sees Mara. Aidan spots Ira. Ari sees God."
NEW_RIGHT = "Dog sees Ira. Ari stops Nadia. Aram sees Aidan"
...
def build_payload() -> dict[str, object]:
    ...
    assert OLD_WINDOW not in rendered
    for clause in (
        "Nadia sees Mara.",
        "Aidan spots Ira.",
        "Ari sees God.",
    ...
    row = {
        "id": "central-diversification-nadia-spots-666",
        ...
        "provenance": (
            "same centered window loaded from the exact d397732a child; the "
            "reviewer-proposed finite-clause diversification consumes the live "
            "reverse-character obligation before independent admission"
        ),
    }

    return {
        "experiment_id": "incumbent-666-central-diversification-20260922",
        "method": "same-window finite-clause diversification with live residual ownership",
        "working_incumbent": {
            "artifact": "runs/incumbent-560-outer-causal-scene-20261002.json",
            "id": "outer-causal-scene-568-working-incumbent",
            "letters": 568,
