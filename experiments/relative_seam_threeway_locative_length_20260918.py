"""Bounded three-way agreement + locative phrase-length repair."""
import hashlib,json,re
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1]; EXPERIMENT='relative-seam-threeway-locative-length-20260918'
...
CHOICES=[('who marks the harbor map','she','records','a map','by','the inlet','short_singular'),('who carry the cedar key','they','carry','maps','near','our wide shores','expanded_plural')]
