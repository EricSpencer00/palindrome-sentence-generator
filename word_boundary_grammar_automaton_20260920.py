...
def run():
    ...
    return {"experiment_id":ID,"method":"bounded word-boundary grammar automaton with three finite event relations, explicit theme-headed attachment graph, and tense state",
      ...
      "next_topology":{"if_no_closure":"add a fourth event relation with an explicit attachment graph and tense state","reason":"current three-event attachment-graph frame bank has no exact closure above the reader threshold"},
