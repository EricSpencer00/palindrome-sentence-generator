...
4,967 rows across 283 routes, with 79 exact controls and 0 admitted outputs.
...
gate. The aggregate is now **5,453 rows across 332 routes, 84 exact rejected
tapes, and 0 mechanically admitted outputs**; the registry is **431 retained,
35 excluded, and 409 retained run artifacts**.
