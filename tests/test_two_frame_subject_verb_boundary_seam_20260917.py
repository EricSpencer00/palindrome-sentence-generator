...
ROOT=Path(__file__).parents[1];spec=importlib.util.spec_from_file_location("s",ROOT/"experiments/two_frame_subject_verb_boundary_seam_20260917.py");mod=importlib.util.module_from_spec(spec);spec.loader.exec_module(mod)
def test_subject_verb_boundary_rejects_rewrites_and_audits():
