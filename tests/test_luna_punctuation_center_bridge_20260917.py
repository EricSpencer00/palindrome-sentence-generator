...
def test_punctuation_center_bridge_has_prose_and_independent_audits():
    ...
    assert result["repair_summary"]["held_out_slots"] == ["right_subject_np", "right_object_np", "right_locative", "right_verb_inflection", "right_determiner_agreement_subject", "right_object_determiner", "right_object_adjective", "right_object_head_noun"]
