...
def build_payload() -> dict[str, object]:
    ...
    return {
        ...
        "rows": [{
            ...
            "raw48_endpoint_obstruction": {
                "prefix_raw_end": 48,
                "prefix_normalized_end": 36,
                "prefix_tape_sha256": "4fcbbb4205a60fbf93198c41f2f08a2f450f8e90964abcae88b9fe5268e6648b",
                "required_reverse_tape": "ehbutastarspotsaronspamsreviledaidan",
                "forbidden_complementary_reverse_cursors": [2, 5, 6, 10, 15, 19, 23, 31],
                "finite_tail_parse": ["Rev", "I", "led", "Aidan"],
                "fatal_reverse_cursor": 31,
                "reflected_prefix_cursor": 5,
                "fragment_only_avoidance": ["rev", "i", "leda", "i", "dan"],
                "lexicon_note": (
                    "the shared fixed lexicon also rejects Nadia, although the "
                    "working track permits typed proper names"
                ),
                "strict_accepts": 0,
                "representation_pivot": (
                    "replace the inherited endpoint entirely with a common-word "
                    "POS/residual transducer that forbids complementary token "
                    "boundaries before surface realization"
                ),
            },
            "provenance": {
            ...
            "next_operator": (
                "start a fresh common-word endpoint-conditioned POS/residual "
                "product; no further cut of this inherited raw-0 endpoint can pass"
            ),
        }],
    }
