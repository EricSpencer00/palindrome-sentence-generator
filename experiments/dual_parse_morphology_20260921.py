...
def run():
    ...
    left = productive_lattice([
        ...
        ("object", [s("theboats", n="plural", d="definite"), s("theboat", n="singular", d="definite")]),
    ...
    right = productive_lattice([
        ...
        ("theme", [s("theboats", n="plural", d="definite"), s("theboat", n="singular", d="definite")]),
