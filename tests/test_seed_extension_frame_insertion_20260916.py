...
def test_frame_probe_forbids_seed_wrapper_and_keeps_prose():
 ...
 for r in p['candidates']:
  assert r['letters']>50 and not r['exact_audit']['two_pointer_exact'];assert not r['exact_audit']['sha_equal'];assert r['provenance']['historical_seed_used_as_output'] is False
