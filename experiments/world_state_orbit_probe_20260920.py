...
def main():
    ...
    out={'experiment_id':'world-state-orbit-probe-20260920','method':'executable world-state precondition/effect orbit before complete surface rendering',
      ...
      'rendered_candidates':rows,'symmetry_search':sym,'provenance':{'generator_sha256':hashlib.sha256(Path(__file__).read_bytes()).hexdigest(),'independent_audits':['world precondition/effect replay','normalized character pointer scan']},
