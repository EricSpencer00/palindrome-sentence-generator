from paragraph_topology_scene_lattice_20260921 import run
def test_bounded_topology():
 ...
 for x in r['candidates']: assert x['complete_prose'] and x['provenance']['synchronous_generation'] and not x['provenance']['posthoc_repair']
def test_audits():
