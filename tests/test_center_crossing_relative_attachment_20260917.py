...
ROOT=Path(__file__).parents[1];spec=importlib.util.spec_from_file_location("r",ROOT/"experiments/center_crossing_relative_attachment_20260917.py");mod=importlib.util.module_from_spec(spec);spec.loader.exec_module(mod)
def test_relative_attachment_is_new_syntax_and_audited():
