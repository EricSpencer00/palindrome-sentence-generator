...
def build() -> None:
    ...
    fresh = [
        ...
        [p("Lexical reverse automaton + Luna frontier", small), p("Brown trie: 2,058 renderings, 2,401 states, 74 letters, 0 exact-clean. First trio: role/discourse/unequal-center controls to 39/73/94 letters. Follow-ups: relative/ditransitive/boundary2 controls to 85/142/46 letters; all 0 exact-clean.", small), p("Expand held-out role classes, object-gap/benefactive edges, and relative-temporal seam states.", small)],
    ]
