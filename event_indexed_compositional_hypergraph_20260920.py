...
ROOT=Path(__file__).resolve().parent;OUT=ROOT/'runs/event-indexed-compositional-hypergraph-20260920.json';ID='event-indexed-compositional-hypergraph-20260920';SIG='event-indexed-hypergraph|two-event-linearization|cause-contrast-temporal-relations|paired-tape-csp'
