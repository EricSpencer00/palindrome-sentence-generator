...
def build_pdf() -> None:
    ...
    round_data = [
        ...
        [para("Seed-extension wrapper search", small), para("25 fresh independently authored prefix/suffix wrapper pairs around an internal seed state; outer equations were live before rendering.", small), para("0 exact; longest 103 letters", small), para("Reader gate closed; next repair authors held-out wrappers ending in the first residual character class.", small)],
