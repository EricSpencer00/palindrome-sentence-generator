...
def test_seed_probes_are_explicitly_excluded_as_overlapping_repairs():
    ...
    assert set(excluded) == {
        ...
        "exact-focused-lexical-edge-dp-20260916-excluded",
        "luna-cfg-exact-intersection-20260917-excluded",
        "luna-lexical-closure-solver-20260917-excluded",
            ...
            "relative-clause-fsa-product-20260917-excluded",
                ...
                "luna-debruijn-window-path-20260917-excluded",
                "luna-causal-scene-graph-20260917",
                "compositional-lm-transition-palindrome-20260917",
                "outer-lexical-chain-20260917",
                    "partial-word-seam-propagation-repair-20260917",
                        "luna-paired-cfg-chart-20260917",
                        "luna-scene-seam-lattice-20260917",
                            "live-fsm-character-obligation-decoder-20260917",
                            "morphology-clitic-boundary-lockstep-20260917",
        "luna-typed-clause-automaton-20260917",
            "luna-boundary-role-domains-20260917",
            "luna-subject-prep-place-domains-20260917",
            "coupled-bidirectional-grammar-20260917",
        "boundary-subword-residual-synonyms-20260917",
        "async-residual-slot-search-20260917",
        "terminal-typed-scene-lattice-20260917",
        "right-boundary-first-grammar-fix-20260917",
        "async-variable-template-intersection-20260917",
        "typed-central-crossing-async-20260917",
        "async-residual-scene-bank-20260917",
        "async-residual-terminal-repair-20260917",
            "character-ngram-residual-decoder-20260917",
            "luna-agreement-carrying-seam-20260917",
            "compositional-residual-grammar-20260917",
            "semantic-valency-attachment-solver-20260917",
            "brown-pos-template-intersection-20260917",
            "reversible-morpheme-transducer-20260917",
            "exact-tape-grammatical-resegmentation-20260917",
            "phrase-pair-semantic-graph-20260917",
            "grammar-product-certificate-20260917",
            "semantic-role-clause-debt-20260917-luna",
            "agreement-resegmented-product-20260917",
            "cross-boundary-seam-lattice-20260917",
            "recursive-cfg-cycle-constructor-20260917",
            "seed-seam-growth-20260917",
            "seed-interior-live-product-20260917",
            "feature-constrained-live-product-20260917",
            "reverse-graph-clause-composition-20260917",
            "flexible-frame-slot-automata-20260917",
            "reverse-edge-resegmented-scene-20260917",
    }
...
def test_preflight_checks_registered_and_excluded_routes():
    ...
    assert result["excluded_routes_checked"] == 78
...
def test_latest_experiments_are_registered_as_distinct_families():
    ...
    assert "reverse-lexicon-boundary-seam-repair-20260916" in ids
    assert "centerout-grammar-boundary-repair2-20260916" in ids
    assert "authored-clause-template-sat-repair2-20260916" in ids
    assert "reverse-lexicon-shared-agreement-seams-20260916" in ids
    assert "centerout-grammar-boundary-repair3-20260916" in ids
    assert "authored-clause-template-sat-repair3-20260916" in ids
    assert "reverse-lexicon-centered-complement-20260916" in ids
    assert "centerout-grammar-boundary-repair4-20260916" in ids
    assert "authored-clause-template-sat-repair4-20260916" in ids
    assert "reverse-lexicon-typed-complement-frame-20260916" in ids
    assert "centerout-grammar-boundary-repair5-20260916" in ids
    assert "authored-clause-template-sat-repair5-20260916" in ids
    assert "reverse-lexicon-role-noun-boundary-20260916" in ids
    assert "centerout-paired-boundary-csp-20260916" in ids
    assert "authored-clause-template-sat-repair6-20260916" in ids
    assert "reverse-lexicon-adjacent-pp-boundary-20260916" in ids
    assert "centerout-paired-boundary-csp-verbframe-20260916" in ids
    assert "authored-clause-template-sat-repair7-20260916" in ids
