...
def fok(s,v,t,p,r,conn,state):
 benefit_verbs={"gives","sends","brings","offers","give","send","bring","offer"}
 relation_ok=v.text in benefit_verbs if state=="benefit" else True
 return (s.number=="plural" and relation_ok and v.valency=="dative" and
         not v.text.endswith("s") and t.number=="plural" and
         t.animacy=="inanimate" and p.text==("for" if state=="benefit" else "to") and
         p.relation==state and r.number=="plural" and r.animacy=="animate" and
         conn.text==("although" if state=="benefit" else "while"))
def controls():
 ts=["The guards give the letters for the children although they send books for them.","The poets offer the seals for the children although they bring books for them.","The sailors bring the letters for the children although they give books for them.","The captains send the seals for the children although they offer books for them.","The guards give the letters to the children while they send books to them.","The poets bring the seals to the children while they show books to them.","The sailors offer the letters to the children while they give books to them.","The captains send the seals to the children while they bring books to them.","The guards bring some books for the children although they give the seals for them.","The poets give the letters for the children although they offer the books for them.","The sailors bring the seals to the children while they send the letters to them.","The captains offer books to the children while they show the seals to them.","The guards send the letters for the children although they bring the books for them.","The poets show the seals to the children while they give the letters to them.","The sailors give books for the children although they offer the seals for them.","The captains bring the letters to the children while they send the books to them.","The guards offer the seals for the children although they bring the books for them.","The poets send the books to the children while they give the seals to them.","The sailors bring the letters for the children although they bring the books for them.","The captains give the seals to the children while they offer the letters to them."]
