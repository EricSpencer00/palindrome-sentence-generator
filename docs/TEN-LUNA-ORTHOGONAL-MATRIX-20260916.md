...
authoritative aggregate is now **5,303 rows across 326 routes** with **84
exact and 0 mechanically admitted**, and the registry is **425 retained, 35
excluded, 403 retained run artifacts**.
