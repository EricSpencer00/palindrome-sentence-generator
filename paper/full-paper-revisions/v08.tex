...
\title{Mirror Cost and Candidate Supply in Exact Palindrome Search}
...
\begin{document}
% Full-paper snapshot 8; critique and successor changes are in FULL-PAPER-REVISION-LEDGER.md.
\maketitle

\begin{abstract}
In 50 paired opening subtrees under a fixed 50,000-popped-state budget, incremental POS-shape pruning produces 5.47 times as many accepted pairs per popped state, with a 2.89--17.65 paired-bootstrap interval, but 0.95 times as many per generated state.
\end{abstract}
...
The study now reports both denominators. It is a bounded candidate-supply result, not a universal speedup or a quality result.

\section*{Limitations}

The opening set, vocabulary, traversal order, and budget bound the finding; no human study evaluates generated prose.
