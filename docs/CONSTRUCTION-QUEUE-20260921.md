...
| Corpus role-bank online CSP | `experiments/corpus_role_online_csp_20260921.py`; `runs/corpus-role-online-csp-20260921.json`; commit `dcc29a34` | 40 three-clause shapes from 40 source controls; 6,128,160 online-CSP nodes; 39–41-letter complete controls; 0 exact. | Recombine role-compatible clauses at the seam instead of retaining each source clause order. |
