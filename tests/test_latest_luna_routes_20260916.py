...
def test_parallel_readability_report_is_diagnostic_and_keeps_provenance():
    ...
    assert report["candidate_count"] == 5453
    ...
    assert by_source["runs/luna-punctuation-center-bridge-20260917.json"]["rows"] == 80
    assert by_source["runs/luna-affix-crossword-prose-20260917.json"]["rows"] == 26
