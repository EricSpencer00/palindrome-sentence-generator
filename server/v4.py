...
BEST_KNOWN_PROVENANCE = {
    ...
    "search_summary": {
        ...
        "latest_packed_single_sentence": "Packed single-sentence grammar: one trie represented 89,856 forward-language strings across 8/9/12-word templates and visited 521,451 states, with zero exact qualifying candidates; dependency/number/valency labels are next",
...
LUNA_PARALLEL_RUNS = [
    ...
    },
    {
        ...
        "reader_eligible": False,
        "first_live_diagnostic": "expanded grammar has no exact qualifying candidate; dependency/number/valency labels remain metadata-only in this pass",
        "provenance": "one forward grammar trie with paired grammar-state traversal and complete endpoint closure; no sentence-pair enumeration, finished-tape reversal, repair, or reranking",
        "independent_validation": ["two-pointer audit", "forward/reverse SHA-256"],
        "next_construction": "carry dependency/number/valency labels in (p, q, n) and enforce them on edge transitions",
    },
]
