...
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'runs/was-np-locative-saw-seam-20260921.json'
NP1=('the quiet scout','a red kite','our old guide','one blue boat')
