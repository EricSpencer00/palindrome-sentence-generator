...
authoritative aggregate is now **5,335 rows across 329 routes** with **84
exact and 0 mechanically admitted**, and the registry is **428 retained, 35
excluded, 406 retained run artifacts**.
