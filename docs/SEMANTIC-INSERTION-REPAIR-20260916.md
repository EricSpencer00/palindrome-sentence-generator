...
The repair operator inserts two distinct, independently authored adjunct spans
after the complete seed predicate and reparses the resulting sentence in
ordinary order. This is a non-neural, corpus-bigram-free probe: no corpus
bigram model or catalogue text is used. The 12 ordered pairs all passed the
independent span check, but the coordinated full sentence failed the bounded
frame gate. There were no exact closures and therefore no reader-worthy
candidates. All 12 ordinary-order near-miss probes, including their first independent tape mismatch, remain in
